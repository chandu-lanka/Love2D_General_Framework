...
function drawParticleCircle(x,y,w)
    love.graphics.circle("fill",x,y,w)
end

function drawParticleSquare(x,y,w)
    offset = w*0.5
    love.graphics.rectangle("fill",x-offset,y-offset,w,w)
end
...
function processParticleSystem(particleSystem)
    ...
    for id,P in pairs(particleSystem.particles) do
        ...
        -- Draw
        DRAWS[particleSystem.particleData.drawMode](P.x,P.y,particleWidth)
    end
